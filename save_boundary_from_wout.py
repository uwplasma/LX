...
def main():
    ...
    # Surface resolution
    ap.add_argument("--ntheta", type=int, default=20, help="Grid points in poloidal angle")
    ap.add_argument("--nphi", type=int, default=80, help="Grid points in toroidal angle")
