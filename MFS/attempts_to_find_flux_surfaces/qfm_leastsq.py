...
def main():
    ...
    ap.add_argument("--axis-seeds", type=int, default=64, help="number of axis anchor points (ψ=0)")
    ...
    ap.add_argument("--proj-seeds", type=int, default=5000, help="Seeds per ψ-level for Newton projection")
    ap.add_argument("--proj-k",     type=int, default=24,   help="Local kNN size for RBF-FD during projection")
    ap.add_argument("--proj-iters", type=int, default=3,    help="Newton iterations for projection")
    ap.add_argument("--lsqr-iter-lim", type=int, default=2500, help="max iterations for lsqr solver")
    args = ap.parse_args()
